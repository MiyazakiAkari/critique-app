...
## 📌 プロジェクト概要
ユーザーはイラストを投稿し、添削を求める。この時謝礼金を設定することができる。
添削者は添削を投稿する。投稿された添削の中から、ポスト投稿者によってベスト添削が選ばれるか、一番いいねの多い添削がベスト添削に選ばれる。
ベスト添削に選ばれた添削者に謝礼金が支払われる。
- ユーザーはイラストを投稿できる
- 投稿には報酬を設定し、添削者に前払い
- 添削は画像・文字・動画が可能
...
私自身、イラストを見ること・描くことが好きで、日頃からXをよく利用しています。そんな中で、イラストの添削を求める投稿を頻繁に目にするようになりました。また、YouTubeでは、かかげ先生やNeg先生などのプロのイラストレーターが、有料でイラスト添削を行っている様子も見かけました。

これらの経験から、イラスト添削には大きな需要がある一方で、それに応えられる場や人が十分に存在していないという課題を感じました。さらに、Xには高い画力を持っているにもかかわらず、うまくマネタイズできていないイラストレーターが多く、収益化の難しさも大きな課題だと考えるようになりました。

そこで、「誰でも簡単にイラストの添削を受けたり、行ったりできる場」を提供したいと思い、このイラスト添削SNSを考えました。
添削を受けたい人は、複数の人からアドバイスをもらうことができ、添削をしたい人は、質の高い添削を提供することで金銭的な報酬を得ることができます。

このサービスが、お互いに価値を提供し合える win-win なCtoCサービスになることを目指しています。
